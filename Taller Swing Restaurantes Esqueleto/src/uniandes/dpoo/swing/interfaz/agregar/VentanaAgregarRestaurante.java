...
public class VentanaAgregarRestaurante extends JFrame
{
    ...
    public VentanaAgregarRestaurante( VentanaPrincipal principal )
    {
        ...
        JPanel sur_panel = new JPanel(new BorderLayout());
        sur_panel.add(panelDetalles, BorderLayout.CENTER);
        sur_panel.add(panelBotones, BorderLayout.SOUTH);
        add(sur_panel, BorderLayout.SOUTH);
